...
const AdminDashboard = {
    ...
    container.innerHTML = products.map((product) => `
     <div class="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
       <div class="flex items-center space-x-4">
         <img src="${product.images?.[0]?.url || 'https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png'}"
              alt="${product.name}"
  ...
  _renderLatestBuyOffers(offers = []) {
    ...
    container.innerHTML = offers.map((offer) => `
     <div class="flex items-center justify-between p-4 hover:bg-gray-50 rounded-lg transition-colors">
       <div class="flex items-center space-x-4">
         <img src="${offer.buyer?.profileImage || 'https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png'}"
