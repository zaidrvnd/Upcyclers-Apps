        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <div class="flex items-center space-x-6">
              <img src="${user?.profileImage || 'https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png'}"
                   alt="Profile picture"
    ...
    return `
      <div class="border rounded-lg p-4">
        <div class="flex items-start space-x-4">
          ${type === 'selling' ? `
            <img src="${item.images[0]?.url || 'https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png'}"
                 alt="${item.name}"
